...
static const char* raisevolcmd[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+5%", NULL };
static const char* lowervolcmd[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-5%", NULL };
...
static const char startpomodorocmd[]  = "~/.config/scripts/pomodoro.sh";
static const char stoppomodorocmd[]   = "pkill pomodoro.sh; echo > /tmp/pomodoro";
...
static const Key keys[] = {
  ...
  { MODKEY|SHIFT, XK_f,      spawn,          {.v = firefoxcmd} },
